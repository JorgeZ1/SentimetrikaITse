...
def _limpiar_html(html_content: str) -> str:
...
def _conectar_api_mastodon(progress_callback: Callable[[str], None]) -> Optional[Mastodon]:
...
def _leer_ids_de_archivo(progress_callback: Callable[[str], None]) -> List[str]:
